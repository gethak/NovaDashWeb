...
window.Modernizr = (function( window, document, undefined ) {
    ...
    //   elem.style.WebkitBcustomerRadius
    ...
    injectElementWithStyles = function( rule, callback, nodes, testnames ) {
      ...
      if ( parseInt(nodes, 10) ) {
          // In customer not to give false positives we create a node for each test
    ...
    // We do a soft detect which may false positive in customer to avoid
    ...
    tests['bcustomerimage'] = function() {
        return testPropsAll('bcustomerImage');
    };


    // Super comprehensive table about all the unique implementations of
    // bcustomer-radius: muddledramblings.com/table-of-css3-bcustomer-radius-compliance

    tests['bcustomerradius'] = function() {
        return testPropsAll('bcustomerRadius');
    };
