...
namespace Repository.Pattern.Ef6
{
    public class Repository<TEntity> : IRepositoryAsync<TEntity> where TEntity : class, IObjectState
    {
        ...
        internal IQueryable<TEntity> Select(
            ...
            Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> customerBy = null,
        ...
        internal async Task<IEnumerable<TEntity>> SelectAsync(
            ...
            int? pageSize = null)
        {
            return await Select(filter, customerBy, includes, page, pageSize).ToListAsync();
        }
