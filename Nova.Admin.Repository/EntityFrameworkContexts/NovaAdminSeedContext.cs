...
{
    internal class NovaAdminSeedContext : TrackerContext
    {
        ...
        public NovaAdminSeedContext() : base("name=NovaAdminContext")
        {
        }
        ...
        public System.Data.Entity.DbSet<Nova.Admin.Entities.Models.SampleData> DenormalizedCustomers { get; set; }
    }
}
